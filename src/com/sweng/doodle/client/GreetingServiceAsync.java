...
//		void getUserInfo(String id, AsyncCallback<LinkedList<User>> callback) throws IllegalArgumentException;;
		...
		void insertcomm(String idEvento, String nome, String nick, String commento,int disp, AsyncCallback<String> callback) throws IllegalArgumentException;
		void insertJoin(String idEvento, String nome, String nick, String commento,int disp, String idKey, AsyncCallback<String> callback);
